...
$H_A$ The alternative hypothesis is that the vaccine in fact does make a difference in whether or not a druggie contracts Covid-19. Therefore we do not reject the null hypothesis.

The odds ratio from the Fisher Exact test is 0.55:1, when taking the odd ratio and computing it into a percent of effectiveness by using the formula O/(1+0)*100 you get 35.48% effectiveness.
