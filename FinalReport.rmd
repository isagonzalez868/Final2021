...
basicCC + geom_bar(stat="identity", position = "dodge")
```
The bar chart shows that out of approximately ??? Druggies who were infected with Covid-19, 32% of those received the drug and 66% were given the placebo.
